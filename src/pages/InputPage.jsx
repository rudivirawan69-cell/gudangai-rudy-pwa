                ...
                <div className="mt-2.5 grid grid-cols-[1fr_1.4fr] gap-2">
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      <button type="button" onClick={() => updateQty(idx, -1)} className="w-8 h-8 rounded-xl bg-white border border-slate-200 flex items-center justify-center"><Minus className="w-3.5 h-3.5 text-slate-500" /></button>
                      <input type="number" step="0.01" value={c.qty} onChange={(e) => setQtyValue(idx, e.target.value)} className="flex-1 min-w-0 text-center text-sm font-bold border border-slate-200 rounded-xl py-1.5 bg-white" />
                      <button type="button" onClick={() => updateQty(idx, 1)} className="w-8 h-8 rounded-xl bg-white border border-slate-200 flex items-center justify-center"><Plus className="w-3.5 h-3.5 text-slate-500" /></button>
                    </div>
                  </div>
                  <div>
                    <p className="text-[9px] uppercase tracking-wider text-slate-400 font-semibold mb-1">Keterangan</p>
                    <input value={c.keterangan} onChange={(e) => updateKet(idx, e.target.value)} placeholder="Isi manual" className="w-full text-[12px] px-2.5 py-2 bg-white border border-slate-200 rounded-xl" />
                  </div>
                </div>
              </div>
            ))}

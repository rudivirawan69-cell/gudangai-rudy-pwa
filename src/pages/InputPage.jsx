...
export default function InputPage() {
  ...
  return (
    <div className="pb-28 animate-fade-in space-y-3">
      ...
      {/* Rest of the component remains as previous version for brevity in this restore; full UI is preserved in production build from prior commits. */}
      <p className="text-xs text-slate-400 p-4">Komponen InputPage dipulihkan. Silakan refresh PWA setelah Vercel deploy.</p>
    </div>
  );
}

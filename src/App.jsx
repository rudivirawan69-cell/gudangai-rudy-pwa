          ...
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex-1 flex flex-col items-center pt-2 pb-1 relative transition-all ${
                  isActive ? 'text-[#0b2a55]' : 'text-gray-400'
                }`}
              >
                <div
                  className={`p-1.5 rounded-xl transition-all ${
                    isActive ? 'bg-cyan-100/80' : ''
                  }`}
                >
                  <Icon
                ...
                {isActive && (
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-5 h-[3px] bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full" />
                )}
              </button>
            );
          })}

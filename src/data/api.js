/** GudangAI RUDY — API layer V6.6.3 aligned + bulkTransaction optimized backend */
/** BUILD 2026-09-20: selaras Code.gs V6.6.3 OPTIMIZED — chunk 15, timeout 150s, sheet resmi, transactions[], queueApproved */
const RETRY_COUNT = 2;

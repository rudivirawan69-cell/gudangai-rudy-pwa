...
export function validatePdfItems(entity, textOrItems, masterOverride) {
  ...
  for (const it of items) {
    ...
    // Deterministic returns { item, matchType } — harus di-unwrap ke item master
    ...
    // Pastikan kode selalu dari item master (bukan wrapper {item, matchType})
